...
public class AMT {
  ...
  public static AMT build(AMTAuth auth) throws ServiceException {
    return new AMT(auth);
  }

  public static AMT build() throws ServiceException {
    return new AMT();
  }

  public AMT() throws ServiceException {
    this(AMTAuth.fromEnv());
  }
